                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                          ...
                                          <div class="col-md-6 mb-3">
                                            ...
                                            <input required type="text" value="<?= $row['nome'] ?>" name="nome" class="form-control">
                                          </div>
                                          <div class="col-md-6 mb-3">
                                            <label for="">Slug (URL)</label>
                                            <input required type="text" value="<?= $row['slug'] ?>" name="slug" class="form-control">
                                          </div>
                                          <div class="col-md-12 mb-3">
                                            <label for="">Descrizione</label>
                                            <textarea required id="summernote" name="descrizione" row="4"  class="form-control"><?= htmlentities($row['descrizione']); ?></textarea>
                                          </div>
                                          <div class="col-md-12 mb-3">
                                            <label for="">Meta Titolo</label>
                                            <input required type="text" name="p_titolo" value="<?= $row['p_titolo'] ?>" max="252" class="form-control">
                                          </div>
                                          <div class="col-md-6 mb-3">
                                            <label for="">Meta Descrizione</label>
                                            <textarea required name="p_descrizione" row="4"  class="form-control"><?= $row['p_descrizione'] ?></textarea>
                                          </div>
                                          <div class="col-md-6 mb-3">
                                            <label for="">Meta Keyword</label>
                                            <textarea required name="p_keyword" row="4"  class="form-control"><?= $row['p_keyword'] ?></textarea>
                                          </div>
                                          <div class="col-md-6 mb-3">
                                          ...
                                          <div class="col-md-6 mb-3">
                                            ...
                                            <input type="checkbox" name="status" value="<?= $row['status'] == '1' ? 'checked' : '' ?>" width="70px" height="70px"/>
                                          </div>
                                          <div class="col-md-12 mb-3">
